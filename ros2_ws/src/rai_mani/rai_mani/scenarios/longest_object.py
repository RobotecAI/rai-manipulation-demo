...
class LongestObject(ScenarioBase):
    ...
    def reset(self):
        ...
        pose_transformed = self.node.tf2_buffer.transform(pose, 'odom', timeout=rclpy.time.Duration(seconds=5.0)).pose
    ...
    def calculate_progress(self):
        ...
        toy_box_position = self.pose_transformed(self.get_entity_pose('toy_box')).position
